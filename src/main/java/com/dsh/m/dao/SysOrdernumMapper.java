...
public interface SysOrdernumMapper {
	 ...
	 * @mbggenerated  Sun Jun 28 10:58:04 CST 2015
	 */
	int updateByExampleSelective(@Param("record") SysOrdernum record,
			@Param("example") SysOrdernumExample example);

	/**
	 * This method was generated by MyBatis Generator. This method corresponds to the database table sys_ordernum
	 * @mbggenerated  Sun Jun 28 10:58:04 CST 2015
	 */
	int updateByExample(@Param("record") SysOrdernum record,
			@Param("example") SysOrdernumExample example);
