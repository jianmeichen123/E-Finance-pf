...
public interface GoodsBclassMapper {
     ...
     * @mbggenerated Wed Jun 17 15:46:43 CST 2015
     */
    int updateByExampleSelective(@Param("record") GoodsBclass record, @Param("example") GoodsBclassExample example);
     ...
     * @mbggenerated Wed Jun 17 15:46:43 CST 2015
     */
    int updateByExample(@Param("record") GoodsBclass record, @Param("example") GoodsBclassExample example);
